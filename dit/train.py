...
def main(args):
    ...
    loader = DataLoader(
        ...
        shuffle=False,  # Shuffle should be False when using sampler
        sampler=sampler,
    ...
    logger.info(f"Dataset contains {len(subset):,} images ({args.data_path})")
    ...
    for epoch in range(args.epochs):
        ...
        for x, y in loader:
            ...
            # model kwargs can be used to pass in additional information to the model, e.g. labels for class-conditional
